...
alias clauded="claude  --permission-mode auto"
alias gcmsg='git commit --message'
alias gcai="python3 $DOTFILE_DIR/shared/scripts/git_scripts/git_commit_ai.py --model qwen-35"
alias gcaic="gcai --model luna"
