...
in {
  ...
  home.file = {
    ...
    ".config/herdr".source = config.lib.file.mkOutOfStoreSymlink "${dotfiles_dir}/shared/herdr";
    ...
    ".config/hypr/.luarc.json".source = config.lib.file.mkOutOfStoreSymlink "${dotfiles_dir}/desktop/linux/hypr/.luarc.json";
